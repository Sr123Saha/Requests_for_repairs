...
- `spec_module.txt`, `algorithms.txt`, `testing_protocol.txt`,  
  `db_and_roles_description.txt`, `modifications_and_quality.txt` — текстовые отчёты по ТЗ (для переноса в Word).


Оценка качества и доработки
---------------------------

Основная функциональность, требуемая по техническому заданию, реализована.  
Возможные направления развития:

- добавить более гибкий поиск и фильтрацию заявок;
- реализовать экспорт отчётов в Excel/PDF;
- внедрить e‑mail/мессенджер‑уведомления;
- добавить автоматические модульные тесты (например, на pytest).
